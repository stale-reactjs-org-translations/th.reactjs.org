...
1. เรโป (repo) ที่ fork แล้ว (สำหรับผู้ที่เป็นผู้สนับสนุน)
...
1. ทำตามคำแนะนำ "การติดตั้ง"
1. เซฟไฟล์และตรวจสอบบนบราวเซอร์
1. การเปลี่ยนแปลงของ React components ใน `src` จะทำให้ฮอทรีโหลด (hot-reload)
1. การเปลี่ยนแปลงของไฟล์มาร์กดาวน์ (markdown) ใน `content` จะทำให้ฮอทรีโหลด (hot-reload)
