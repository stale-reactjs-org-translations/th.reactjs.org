...
เพื่อจะแก้ใข ให้ใช้รูปแบบที่สองของ `setState()` ซึ่งจะใช้ฟังก์ชั่นเป็นอาร์กิวเมนท์ แทนที่การใช้ออบเจ็ค ซึ่งฟังก์ชั่นนั้นจะรับค่าของ `สถานะก่อนหน้า` เป็นอาร์กิวเมนท์แรก และค่าของ `props` ในขณะนั้นเป็นอากิวเมนท์ที่สอง:
...
เราจะบอกได้ว่าสิ่งนี้เป็นคอมโพเนนท์หรือไม่นั้นให้เราดูว่า คอมโพเนนท์นั้นมี สถานะ หรือไม่ ซึ่งไม่จำเป็นว่าจะสร้างมาจากฟังก์ชั่นหรือคลาส
...
ใน React apps ไม่ว่าคอมโพเนนท์นั้นจะมี สถานะ หรือไม่ ให้ระลึกไว้ว่ารายละเอียดภายในคอมโพเนนท์นั้นสามารถเปลี่ยนแปลงได้เสมอ ซึ่งในทางกลับกัน คุณจะสามารถใช้คอมโพเนนท์ที่มีสถานะใน คอมโพเนนท์ที่ไม่มีสถานะได้เช่นกัน